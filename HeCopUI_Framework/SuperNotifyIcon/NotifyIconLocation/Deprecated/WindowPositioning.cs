    ...
    public class WindowPositioning
    {
        ...
        public static int WindowEdgeOffset
        {
            get
            {
                ...
                if (HeCopUI_Framework.SuperNotifyIcon.SysInfo.IsDWMEnabled)
                    if (HeCopUI_Framework.SuperNotifyIcon.SysInfo.IsWindows7OrLater)
        ...
        public static System.Windows.Point GetWindowPosition(NotifyIcon notifyicon, double windowwidth, double windowheight, double dpi, bool pinned)
        {
            ...
            return new System.Windows.Point((int)windowleft, (int)windowtop);
        }
