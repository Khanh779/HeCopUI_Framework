...
namespace HeCopUI_Framework.Controls
{
    public partial class MetroListView : ListView
    {
        ...
        private Font stdFont = new Font("Segoe UI", 12f);
        ...
        [DllImport("Msg.dll", EntryPoint = "GetWindowLong", CharSet = CharSet.Auto)]
        public static extern IntPtr GetWindowLong32(IntPtr hWnd, int nIndex);

        [DllImport("Msg.dll", EntryPoint = "GetWindowLongPtr", CharSet = CharSet.Auto)]
        public static extern IntPtr GetWindowLongPtr64(IntPtr hWnd, int nIndex);

        [DllImport("Msg.dll", EntryPoint = "SetWindowLong", CharSet = CharSet.Auto)]
        public static extern IntPtr SetWindowLongPtr32(IntPtr hWnd, int nIndex, int dwNewLong);

        [DllImport("Msg.dll", EntryPoint = "SetWindowLongPtr", CharSet = CharSet.Auto)]
        ...
        private Color itemForedColor = Color.LightGray;
        private Color itemSelectedColor = Color.Gray;
        private Color itemCheckedColor = Color.DimGray;
        private Color itemColor = Color.White;
        private Color itemTextColor = Color.Black;
        private Color headerColor = Color.White;
        private Color headerTextColor = Color.DimGray;

        void MetroListView_DrawSubItem(object sender, DrawListViewSubItemEventArgs e)
        {
            Color itemForeColor = itemForedColor;
            if (this.View == View.Details)
            {
                ...
                {
                    e.DrawDefault = false;
                    e.Graphics.FillRectangle(new SolidBrush(itemSelectedColor), e.Bounds);
                ...
                if (this.CheckBoxes && e.ColumnIndex == 0)
                {
                    ...
                    if (e.Item.Checked)
                    {
                        Color fillColor = itemColor;
                        if (e.Item.Selected) fillColor = itemSelectedColor;
...
#pragma warning restore CS0219 // Variable is assigned but its value is never used
                using (StringFormat sf = new StringFormat())
                {
                    ...
                    TextRenderer.DrawText(e.Graphics, e.SubItem.Text, stdFont, rect, itemTextColor, align | TextFormatFlags.SingleLine | TextFormatFlags.GlyphOverhangPadding | TextFormatFlags.VerticalCenter | TextFormatFlags.WordEllipsis);
                }
            }
            else
            {
        ...
        void MetroListView_DrawItem(object sender, DrawListViewItemEventArgs e)
        {
            ...
            if (this.View == View.Details | this.View == View.List | this.View == View.SmallIcon)
            {
                ...
                Rectangle rect = new Rectangle(e.Bounds.X + _left, e.Bounds.Y, _colWidth - _ded, e.Item.Bounds.Height);
                TextRenderer.DrawText(e.Graphics, e.Item.Text, stdFont, rect, itemTextColor, align | TextFormatFlags.SingleLine | TextFormatFlags.GlyphOverhangPadding | TextFormatFlags.VerticalCenter | TextFormatFlags.WordEllipsis);
            }
        ...
        void MetroListView_DrawColumnHeader(object sender, DrawListViewColumnHeaderEventArgs e)
        {
            ...
            {
                sf.Alignment = StringAlignment.Center;
                e.Graphics.DrawString(e.Header.Text, stdFont, new SolidBrush(headerTextColor), e.Bounds, sf);
            }
        }
    }
}
